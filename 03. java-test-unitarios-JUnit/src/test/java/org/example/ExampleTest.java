...
public class ExampleTest {
    ...
    public void testSumar() {
        ...
        // Then - Entonces
        assertNotNull(result); // Evaluar que el resultado no sea nulo
        assertEquals(6, result); // Evaluar un resultado esperado con uno obtenido
        assertInstanceOf(Integer.class, result); // Evaluar que el resultado sea de un tipo específico
    }
